...
python3 runmeka.py rcv1subset1500 -c 101 -f 5 -mc meka.classifiers.multilabel.BR -o ./exp/meka/nbbr/ > ./exp/meka/nbbr/rcv15.log
python3 runmeka.py rcv1subset2500 -c 101 -f 5 -mc meka.classifiers.multilabel.BR -o ./exp/meka/nbbr/ > ./exp/meka/nbbr/rcv25.log
python3 runmeka.py rcv1subset3500 -c 101 -f 5 -mc meka.classifiers.multilabel.BR -o ./exp/meka/nbbr/ > ./exp/meka/nbbr/rcv35.log
python3 runmeka.py rcv1subset4500 -c 101 -f 5 -mc meka.classifiers.multilabel.BR -o ./exp/meka/nbbr/ > ./exp/meka/nbbr/rcv45.log
python3 runmeka.py rcv1subset5500 -c 101 -f 5 -mc meka.classifiers.multilabel.BR -o ./exp/meka/nbbr/ > ./exp/meka/nbbr/rcv55.log
...
python3 runmeka.py rcv1subset1500 -c 101 -f 5 -mc meka.classifiers.multilabel.CC -o ./exp/meka/nbcc/ > ./exp/meka/nbcc/rcv15.log
python3 runmeka.py rcv1subset2500 -c 101 -f 5 -mc meka.classifiers.multilabel.CC -o ./exp/meka/nbcc/ > ./exp/meka/nbcc/rcv25.log
python3 runmeka.py rcv1subset3500 -c 101 -f 5 -mc meka.classifiers.multilabel.CC -o ./exp/meka/nbcc/ > ./exp/meka/nbcc/rcv35.log
python3 runmeka.py rcv1subset4500 -c 101 -f 5 -mc meka.classifiers.multilabel.CC -o ./exp/meka/nbcc/ > ./exp/meka/nbcc/rcv45.log
python3 runmeka.py rcv1subset5500 -c 101 -f 5 -mc meka.classifiers.multilabel.CC -o ./exp/meka/nbcc/ > ./exp/meka/nbcc/rcv55.log
